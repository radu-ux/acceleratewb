    ...
    return (
        <section className="flex flex-col mt-12 2xl:mt-20">
            ...
            <div className="flex flex-col md:flex-row justify-center mt-10 mb-3 mx-8 md:mx-0">
                ...
                <Card cardImage={ProgressiveWebAppIcon} cardEffect="zoom-in" cardTitle="Aplicații Web Progresive" _class="md:ml-3">
            ...
            <div className="flex flex-col md:flex-row justify-center mt-3 mb-10 mx-8 md:mx-0">
                <Card cardImage={SoftwareAutomationIcon} cardEffect="zoom-in" cardTitle="Branding Digital și SEO" _class="mb-8 md:mb-0 md:mr-3">
                ...
                <Card cardImage={WebHostingIcon} cardEffect="zoom-in" cardTitle="Găzduire Web si Mentenanță" _class="md:ml-3">
