...
const Card = ({image, title, children, classN}) => {
    return (
        <div data-aos="flip-left" className={`flex flex-col border-2 border-gray-200 shadow-xl max-w-xs lg:w-full sm:min-h-96 2xl:max-h-full lg:px-10 xl:px-0 ${classN}`}>
